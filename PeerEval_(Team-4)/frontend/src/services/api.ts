...
// ✅ CRITICAL FIX: Fixed api.ts - RefreshToken variable name bug
import axios, { AxiosInstance, AxiosRequestConfig, AxiosResponse } from "axios";
...
class ApiService {
  ...
  // ✅ CRITICAL FIX: Fixed refresh token variable name and payload
  private async refreshToken(): Promise<void> {
    try {
  ...
  // ✅ NEW: Helper method to normalize endpoints
...
//   constructor() {
//     this.axiosInstance = axios.create({
//       baseURL: import.meta.env.VITE_API_URL || "http://localhost:8024/api/v1",
//       timeout: 10000,
//       withCredentials: true, // Include cookies
//       headers: {
//         "Content-Type": "application/json",
...
//           withCredentials: true,
//           baseURL:
//             import.meta.env.VITE_API_URL || "http://localhost:8024/api/v1",
//         }
//       );
