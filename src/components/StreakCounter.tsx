...
interface StreakCounterProps {
  // Have to be stored in some database
  currentStreak: number;
  bestStreak: number;
}

const StreakCounter: React.FC<StreakCounterProps> = ({
  // Destructuring the props to local variables
  currentStreak,
  bestStreak,
}) => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 dark:shadow-amber-500 dark:border-red-500 h-fit dark:bg-slate-600">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-white mb-6 font-bold">
          {" "}
          days in a row{" "}
        </p>
