    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-lg dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 space-y-3 sm:space-y-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Weekly Progress</h3>
      ...
      <div className="space-y-4">
        <div className="flex items-end justify-between h-32 sm:h-48 px-1 sm:px-2">
          {data.map((item, index) => {
            ...
            return (
              <div key={item.day} className="flex flex-col items-center space-y-1 sm:space-y-2 flex-1">
                ...
                <span className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">{item.day}</span>
              </div>
            );
          })}
        </div>
